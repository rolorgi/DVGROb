...
coarse_model_and_render = dict(
    ...
    bbox_thres=1e-7,              # threshold to determine known free-space in the fine stage
    mask_cache_thres=1e-7,        # threshold to determine a tighten BBox in the fine stage
